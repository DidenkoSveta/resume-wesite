document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      'project-overview__title': 'Development of a Corporate Website for "Don-Art"',
      'project-overview__subtitle': 'Industrial Chemical Manufacturer',
    ...
    ru: {
      ...
      'project-overview__title': 'Разработка корпоративного веб-сайта для \"Дон-Арт\"',
      'project-overview__subtitle': 'Производитель промышленной химии',
